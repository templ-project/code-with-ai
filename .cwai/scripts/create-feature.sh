...
create_new_feature() {
  ...
  local feature_id feature_padded_id feature_name feature_slug feature_parent_dir feature_dir
...
update_existing_feature() {
  ...
  local feature_id feature_padded_id feature_title="" feature_slug feature_parent_dir feature_dir
